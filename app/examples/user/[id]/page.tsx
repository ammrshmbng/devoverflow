...
export default function UserPage({ params }: { params: { id: string } }) {
  ...
  return (
    <div className="container mx-auto py-8 px-4">
      <h1 className="text-3xl font-bold mb-6">Halaman User ID: {id}</h1>
      <p className="mb-6">
        Ini adalah halaman user lengkap. Jika Anda mengakses halaman ini
        langsung, Anda akan melihat halaman penuh ini, bukan dalam modal.
      </p>

      <div className="p-4 bg-green-100 mb-6 rounded-lg">
